...
export const PLUGINS_CONTAINER_ID = 'realmail-plugins';
export const SYNC_SCROLL_ELEMENT_CLASS_NAME = 'realmail-sync-scroll';
export const RICH_TEXT_BAR_ID = 'realmail-rich-text-bar';
...
export const CONTENT_EDITABLE_CLASS_NAME = 'realmail-content_editable_text_only';
export const CONTENT_EDITABLE_RICH_TEXT_CLASS_NAME = 'realmail-content_editable_rich_text';
