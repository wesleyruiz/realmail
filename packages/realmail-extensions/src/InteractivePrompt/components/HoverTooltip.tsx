...
import { getNodeTypeFromClassName, BlockManager } from 'realmail-core';
...
import { useLazyState } from 'realmail-editor';
...
export function HoverTooltip() {
  ...
  return (
    <>
      {createPortal(
        <div
          id='realmail-extensions-InteractivePrompt-HoverTooltip'
          style={{
            position: 'absolute',
            height: '100%',
            width: '100%',
