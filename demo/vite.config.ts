...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'realmail-extensions/lib/style.css': path.resolve(
        __dirname,
        'package.json'
      ), // 没有用的，只是防止css 404报错
      ...
      '@extensions': path.resolve('../packages/realmail-extensions/src'),
      '@core': path.resolve('../packages/realmail-core/src'),
      '@arco-themes': path.resolve('./node_modules/@arco-themes'),
      '@': path.resolve('../packages/realmail-editor/src'),
      'realmail-core': path.resolve(
        '../packages/realmail-core/src/index.tsx'
      ),
      'realmail-editor': path.resolve(
        '../packages/realmail-editor/src/index.tsx'
      ),
      'realmail-extensions': path.resolve(
        '../packages/realmail-extensions/src/index.tsx'
      ),
    },
  },
